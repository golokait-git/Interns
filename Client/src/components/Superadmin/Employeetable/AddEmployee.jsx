...
const AddEmployee = () => {
  ...
  const handleSubmit = (values) => {
    ...
    axios
      .post("http://localhost:5000/auth/employee", formData) // Adjusted this line
      .then((result) => {
        console.log(result);
        if (result.data.Status) {
  ...
  <div className="bg-white rounded-lg border w-full md:w-3/4 lg:w-1/2 xl:w-2/3 p-6">
    ...
    >
            ...
            <Form.Item wrapperCol={{ offset: 12, span: 12 }}>
              <Button type="primary" htmlType="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-auto me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                Add Employee
              </Button>
            </Form.Item>
          </Form>
