...
const EmployeeStatus = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/employee/status/${id}`)
      .then((result) => {
  ...
  const getStatusDisplay = (statusValue) => {
    switch (statusValue) {
      ...
      case "Disapprove1":
        return (
          <div className="status-container disapproved">
            <div className="admins">
              <div  className="flex flex-row-reverse">ADMIN 1 <MdDisabledByDefault color="red" /></div>
              <br />
              <div  className="flex flex-row-reverse">  ADMIN 2 <MdDisabledByDefault color="red" /></div>
            </div>
            <div className="status-icon">
      ...
      case "HalfLeave":
        return (
          <div className="status-container approved justify-start items-start flex">
            <div className="admins ">
             <div className="flex flex-row-reverse"> ADMIN 1<FaCheckSquare color="green" className="check-icon flex" /></div> 
              <br />
              <div className="flex flex-row-reverse"> ADMIN 2<FaCheckSquare color="green" className="check-icon flex" /></div> 
            </div>
            <div className="status-icon">
              <AiFillCheckCircle color="green" />
              <span>APPROVED</span>
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "status",
      align: "center",
      className: "last-column", // Apply custom class to the last column
  ...
  return (
    <div className="px-5 mt-3">
      <div className="flex justify-center">
        <h3 className="text-3xl font-semibold">Leave Records</h3>
      </div>
