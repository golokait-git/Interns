...
import { FiMessageSquare, FiClipboard, FiLogOut } from "react-icons/fi";
...
const Home = () => {
  ...
  const menus = [
    {
      name: "Profile",
      link: `/employee_detail/${id}`,
      icon: MdPerson,
    },
    {
      name: "Leave Application",
      link: `/employee_detail/${id}/leaveapplication`,
      icon: FiMessageSquare,
    },
    {
      name: "Employee Status",
      link: `/employee_detail/${id}/employee_status`,
      icon: FiClipboard,
    },
