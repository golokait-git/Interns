    ...
    >
      ...
      >
        ...
        <div className="flex w flex-col p-4 leading-normal max-w-5xl
          2xl:w-full 2xl:ml-10 w-[90%] mx-auto">
          <h5
            className="mb-2 text-2xl font-bold
           tracking-tight text-gray-900 text-white  text-left lg:text-left 2xl:text-3xl 
           2xl:text-2xl w-full"
          >
          ...
          <p
            className="mb-3 font-normal text-gray-200 w-3xl 2xl:w-full 2xl:text-lg 
          text-left lg:text-left 2xl:text-lg w-full"
          >
            {/* Adjusted width using max-w-3xl */}
            {courseSlug}
          </p>
