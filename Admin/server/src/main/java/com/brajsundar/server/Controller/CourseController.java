...
public class CourseController {
    ...
    @PostMapping("/course")
    public ResponseEntity<Courses> uploadCourse(@RequestParam("file") MultipartFile file, String name, String description,String exclyUrl
            ) {
        return ResponseEntity.ok()
                .body(this.courseService.uploadCourse(name, description,file, exclyUrl));
    }
