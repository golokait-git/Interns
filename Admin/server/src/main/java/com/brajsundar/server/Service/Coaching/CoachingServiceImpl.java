...
public class CoachingServiceImpl implements CoachingService {
    ...
    @Override
    public Coaching uploadCoaching(MultipartFile file, String name, String description, String exclyUrl) {
        try {
            ...
            String folderPath ="Images/Coaching/" + objectId.toHexString() + "/";
            ...
            // Construct the Coaching object with the correct fields
            Coaching coaching = new Coaching(name, description, s3Key, exclyUrl, objectId);
            
            // Save the Coaching object to the repository
        ...
        if (coaching.isPresent()) {
            ...
            try {
                ...
                if (newThumbnail != null && !newThumbnail.isEmpty()) {
                    ...
                    String folderPath =  "Images/Coaching/"
                            + existingCoaching.getId() + "/";
