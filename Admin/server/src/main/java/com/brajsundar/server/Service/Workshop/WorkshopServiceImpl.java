...
public class WorkshopServiceImpl implements WorkshopService {
    ...
    @Override
    public Workshop uploadWorkshop(MultipartFile file, String name, String description, String exclyUrl) {
        try {
            ObjectMetadata metadata = new ObjectMetadata();
            metadata.setContentType(file.getContentType());
    
            ObjectId objectId = new ObjectId();
            String folderPath = "Images/Workshop/" + objectId.toHexString() + "/";
            ...
            Workshop workshop = new Workshop(name, description, s3Key, exclyUrl, objectId); // Corrected parameter order
        ...
        if (Workshop.isPresent()) {
            ...
            try {
                ...
                if (newThumbnail != null && !newThumbnail.isEmpty()) {
                    ...
                    String folderPath = "Images/Workshop/"
                            + existingWorkshop.getId() + "/";
